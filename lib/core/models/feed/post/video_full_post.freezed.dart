...
VideoFullPost _$VideoFullPostFromJson(Map<String, dynamic> json) {
  return _VideoFullPost.fromJson(json);
}

/// @nodoc
mixin _$VideoFullPost {
  ...
  @JsonKey(ignore: true)
  $VideoFullPostCopyWith<VideoFullPost> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $VideoFullPostCopyWith<$Res> {
  factory $VideoFullPostCopyWith(
          VideoFullPost value, $Res Function(VideoFullPost) then) =
      _$VideoFullPostCopyWithImpl<$Res, VideoFullPost>;
  @useResult
  $Res call(
      {String id,
      String cover,
...
/// @nodoc
class _$VideoFullPostCopyWithImpl<$Res, $Val extends VideoFullPost>
    implements $VideoFullPostCopyWith<$Res> {
  _$VideoFullPostCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_VideoFullPostCopyWith<$Res>
    implements $VideoFullPostCopyWith<$Res> {
  factory _$$_VideoFullPostCopyWith(
          _$_VideoFullPost value, $Res Function(_$_VideoFullPost) then) =
      __$$_VideoFullPostCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$_VideoFullPostCopyWithImpl<$Res>
    extends _$VideoFullPostCopyWithImpl<$Res, _$_VideoFullPost>
    implements _$$_VideoFullPostCopyWith<$Res> {
  __$$_VideoFullPostCopyWithImpl(
      _$_VideoFullPost _value, $Res Function(_$_VideoFullPost) _then)
      : super(_value, _then);
...
class _$_VideoFullPost implements _VideoFullPost {
  const _$_VideoFullPost(
      {required this.id,
      required this.cover,
      required this.src,
      required this.title,
  ...
  factory _$_VideoFullPost.fromJson(Map<String, dynamic> json) =>
      _$$_VideoFullPostFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_VideoFullPostCopyWith<_$_VideoFullPost> get copyWith =>
      __$$_VideoFullPostCopyWithImpl<_$_VideoFullPost>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_VideoFullPostToJson(
      this,
    );
  }
}

abstract class _VideoFullPost implements VideoFullPost {
  const factory _VideoFullPost(
      ...
      @JsonKey(unknownEnumValue: FeedKind.image)
          required final FeedKind kind}) = _$_VideoFullPost;

  factory _VideoFullPost.fromJson(Map<String, dynamic> json) =
      _$_VideoFullPost.fromJson;
