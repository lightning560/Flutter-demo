class Api {
  static const String BASE_URL = "https://www.xxx.com/";

  static const String MOCK_URL =
      "http://192.168.1.102:4523/m1/2327029-0-default/";
  static const String Local_MOCK_URL =
      "http://127.0.0.1:4523/m1/2327029-0-default/";
  static const String TEST_URL = "https://api.hencoder.com/author";

  /// get feed cards
  static const String FEED_CARDS = "feed/cards";
  //首页banner
